            ...
            <div class="container">
                <div class="row g-0  " style="padding-top: 5rem;">
                    ...
                    <div class="col-12 col-md-6 col-lg-6 d-flex align-items-center "
                        style="background: #FFFFFF 0% 0% no-repeat padding-box; box-shadow: 10px 10px 60px rgba(32, 114, 190, 0.1); border-radius: 0px 5px 5px 0px; height: 387px;padding: 61px 85px; ">
                        <div class="">
